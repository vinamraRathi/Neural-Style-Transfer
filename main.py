...
img_dir = '/home/vinamra/PycharmProjects/Neural_Style_Transfer/'
...
def decompress_img(processed_img):
...
def run_style_transfer(content_path,
    ...
    for i in range(num_iterations):
        ...
        if loss < best_loss:
            ...
            best_loss = loss
            best_img = decompress_img(init_image.numpy())
        ...
        if i % display_interval == 0:
            ...
            plot_img = decompress_img(plot_img)
...
result_image = Image.fromarray(best)
